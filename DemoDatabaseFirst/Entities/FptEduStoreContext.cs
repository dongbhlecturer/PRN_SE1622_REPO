...
{
    public partial class FptEduStoreContext : DbContext
    {
        public FptEduStoreContext()
        {
        }

        public FptEduStoreContext(DbContextOptions<FptEduStoreContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server =(local); database = FptEduStore;uid=sa;pwd=sa;MultipleActiveResultSets=true");
            }
        }
